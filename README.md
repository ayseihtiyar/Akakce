...
## User Stories
- **User Account Creation :** Enables new users to create a personalized account, facilitating a tailored shopping experience.
- **Account Verification Check :** Upon successful login, users can see their name in the profile section, enhancing the sense of security.
- **Logout Functionality :** Allows users to securely log out, protecting their account and enhancing privacy.
- **Login Functionality :** Users can log in to their accounts, saving preferences and streamlining the shopping process.
- **Order List Verification :** Logged-in users can view their order history, aiding in purchase management and planning.
- **Message Box Accessibility :** Users can check their message box for special campaigns or notifications, ensuring they don't miss out on offers.
- **Account Deletion :** Provides users with the option to delete their account, offering control over personal data and privacy.
